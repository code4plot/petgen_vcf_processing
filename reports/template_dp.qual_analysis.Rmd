---
title: "<project> DP QUAL report" # replace this title accordingly
author: "jlai"
date: '2022-05-14' 
...
in.vcf <- read_tsv("../HaplotypeCaller_merged_snpEff.ann.vcf.gz", comment = "#", col_names = F) # replace input before hitting start/knit
```
